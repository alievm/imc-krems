                ...
                <div>
                    <div className="mx-auto p-10 text-center w-full">
                        <FadeIn>
                            ...
                            >
                                At our double degree faculty, we pride ourselves on our practical and
                                industry-focused
                                curriculum. As a University of Applied Sciences, we emphasize the importance of
                                linking
                            ...
                            <section className="bg-white dark:bg-gray-900">
                                <div
                                    ...
                                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                                        ...
                                        <p className="mb-4"> Our curriculum is uniquely designed to ensure that students not only learn but
                                            also
                                            ...
                                            industry operations, and apply the theories and skills they've learned in class.</p>
                                    </div>
                    ...
                    <header className="relative bg-cover bg-center h-96"
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center max-w-3xl text-white">
                                ...
                                <p className="text-lg">
                                    After completing the internship, students return to the university to present
                                    their
                                    experiences and the knowledge they have gained. This presentation is a crucial
                                    part
                                    of their learning process, allowing them to reflect on their time in the
                                    industry,
                    ...
                    <div className="mx-auto flex max-w-[58rem] py-5 flex-col items-center space-y-4 text-center">
                        ...
                        <p className="max-w-[85%] leading-normal sm:text-lg sm:leading-7">
                            ...
                            opportunities to work and learn in real-world environments. Some of our esteemed
                            partners
                            include:
                        </p>
                    ...
                    <Section title="Industry Experience" image={{src: imageWhiteboard, shape: 1}}>
                        <div className="space-y-6 text-base text-neutral-600">
                            <p>
                                ...
                                academic knowledge to practical situations. This invaluable experience helps them
                                to:
                            </p>
                            <p>
                                <strong className="text-gray-900">Develop professional skills</strong> <br/>
                                <strong className="text-gray-900">Understand industry standards and
                                    practices</strong>
                                <br/>
                                <strong className="text-gray-900">Network with professionals in their field</strong>
                                <br/>
                                <strong className="text-gray-900">Gain insights into their future careers</strong>
                                <br/>
                            </p>
                        </div>
                    </Section>
                        ...
                        <Section title="Internships in Top Dubai Hotels" image={{src: imageWhiteboard, shape: 1}}>
                            <div className="space-y-6 text-base text-neutral-600">
                                <p>
                                    ...
                                    markets
                                    in the world. These internships provide students with unparalleled exposure to
                                    the
