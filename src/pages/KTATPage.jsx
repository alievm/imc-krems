        ...
        <div className="px-4 py-8 bg-gray-50 min-h-screen">
            <div className="max-w-full mx-auto">
                ...
                >
                    ...
                    <div className="max-w-full w-full bg-white p-6 ">
                        <div className="lg:flex-nowrap relative items-center flex-wrap">
                            ...
                            <PageIntro eyebrow="Learn about KTAT initiatives "
                                       title="About KTAT">
                              <div className="text-center">
                                  The Krems Tashkent Admission Test (KTAT) is a comprehensive assessment designed to evaluate your
                                  readiness for the academic programs at our faculty. The test ensures that all students meet the
                                  required standards in key academic areas and possess the necessary skills for success in their
                                  studies.
                              </div>
                            </PageIntro>
                        ...
                        <Card className="mb-8">
                            ...
                            <Paragraph className="text-xl">
                                <b>Purpose:</b> To assess your English language proficiency, including grammar, vocabulary,
                        ...
                        <Card className="mb-8">
                            <Paragraph className="text-xl">
                                ...
                                <ol>
                                    <li>Introduction: You will introduce yourself and discuss your background, interests,
                                        and goals.
                                    </li>
                                    <li>Discussion Topics: You will be asked to discuss specific topics related to your
                                        academic interests or current events.
                                    </li>
                                    <li>Role Play: You might engage in a role-play exercise where you respond to
                                        hypothetical scenarios or solve problems.
                                    </li>
                                </ol>
                            </Paragraph>
                            <Paragraph className="text-xl">
                        ...
                        <ul className="mb-8">
                            <li>Review Basic Concepts: Brush up on English grammar and vocabulary, basic math principles,
                                and logical reasoning strategies.
                            </li>
                            <li>Practice Sample Questions: Work on sample questions for English, Math, and Logic to
                                familiarize yourself with the test format.
                            </li>
                            <li>Improve Speaking Skills: Practice speaking English with friends, family, or through language
                                exchange programs.
                            </li>
                        </ul>
                        ...
                        <Paragraph className="mb-8 text-xl">
                            The KTAT is held on specific dates throughout the year. Please check our website or contact the
                            admissions office for the upcoming test dates and registration deadlines.
                        </Paragraph>
                ...
                <div className="mt-8 text-center">
                    ...
                    <Paragraph className="mb-4 text-xl">
                        Written Exam: English Test: 30 questions, Math Test: 10 questions, Logic Test: 10 questions - 50
                        Questions Total
                    </Paragraph>
                    <Paragraph className="mb-4 text-xl">
